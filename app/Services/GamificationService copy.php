...
class GamificationService
{
    ...
    private static function applyStreakBonusXp(User $user, int $streakDay): void
    {
        $bonusKey = "streak_{$streakDay}";
        ...
        $alreadyLogged = PointsLog::where('user_id', $user->id)
            ->where('type', 'streak')
            ->where('meta->day', $streakDay)
            ->exists();
